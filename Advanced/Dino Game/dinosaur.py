...
class Dinosaur:
    ...
    def draw(self,display):
        self.hi = pygame.draw.rect(display,dinocolour,[self.x,self.surfaceHeight-self.y-self.height,self.width,self.height])
        dino = pygame.image.load("Advanced/Images/Dino.png")
        dino = pygame.transform.scale(dino,(20, 40))
        image_x = 60
        image_y = self.surfaceHeight-self.y-self.height
        display.blit(dino, (image_x, image_y))
