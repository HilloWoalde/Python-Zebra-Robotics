...
pygame.display.set_caption("Hummingbird Shooter")
...
while quitVar == True:
    ...
    font = pygame.font.Font("Advanced\Fonts\Papyrus.ttf", 20)
    text = font.render("Score: " + (str)(score) + ", Shots: " + (str)(shots), True, AQUA)
    ...
    if time < 600:
        ...
        birds.clear()
        font2 = pygame.font.Font("Advanced\Fonts\Papyrus.ttf", 100)
        text2 = font2.render("Time's Up!", True, AQUA)
